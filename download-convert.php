...
$filename = 'orders-convert.csv';
//$export_data = unserialize($_POST['export_order_data']);
$file_order = $_POST['submit_convert'];
if($file_order){
                    ...
                    while (($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
                        ...
                        if($sku != '') {
                            ...
                            foreach ($options as $option) {
                                ...
                                if($data_convert[0] == 'Color') {
                                    $background = $data_convert[1];
                                }
//                                if (strpos($option, 'Color') !== false) {
//                                    $background = str_replace("Color:", "", $option);
//                                }
//                                if ((strpos($option, 'Option-Background_Color') !== true) ){
//                                    $background = str_replace("Option-Background_Color: ", "", $option);
//                                } else {
//                                    if((strpos($option, 'Color - Color') !== true)) {
//                                        $background = str_replace("Color - Color", "", $option);
//                                    } else {
//                                        if((strpos($option, 'Color') !== true)){
//                                            $background = str_replace("Color", "", $option);
//                                        }
//                                    }
//                                }
                                ...
                                if (strpos($option, 'Font:') !== false) {
                                    $font = str_replace("Font: ", "", $option);
                                }
//                                if (strpos($option, 'Option-Icon_Name') !== false) {
//                                    $character = str_replace("Option-Icon_Name: ", "", $option);
//                                }

                                if(in_array($data_convert[0], $list_character)) {
//                                    $character = str_replace("Super Hero: ", "", $option);
                                    $character = $data_convert[1];
                                }
...
//                                    $character = str_replace("Option-Icon_Name: ", "", $option);
//                                }
                                    if(in_array($option, $list_character)) {
                                        $character = str_replace("Super Hero: ", "", $option);
                                    }
                                    if (strpos($option, 'Line 1') !== false) {
                                        $line1 = str_replace("Line 1: ", "", $option);
                            ...
                            //------------------------------------------------------------------
                            if ($sku == 'clothing-tags') {
                                $options = explode(", ", $data[3]);
                                $background = $fontcolor = $font = $character = $line1 = $line2 = '';
                                $background_1 = $fontcolor_1 = $font_1 = $character_1 = $line1_1 = $line2_1 = $copies = '';

                                foreach ($options as $option) {
//                                    if (strpos($option, 'Clothing Tags') !== false) {
//                                        $copies = 4;
//                                    }
                                    if (strpos($option, 'Sheets') !== false) {
                                        preg_match('/(\d) Sheets/', $option, $matches);
